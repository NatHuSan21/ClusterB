...
for k in range(1,25):#25
    ...
    for lam in LAMval:
        ...
        ruta = './restoration/P274B/deblur_P274B_'
        fname = ruta + str(Lambda)  + nameimg 
        out_img_avg_pil.save(fname)

        #Save best image 
        imgPNSRmax_pil = np_to_pil(imgPNSRmax_np)
        fname = './restoration/P274B/BestPnsr_P274B_' + str(Lambda) + nameimg 
...
#name = nameimg.replace('.png','.csv')
name = 'KodimTotal.csv'
fname = ruta  + 'P274BdebMAXval' + name
