...
for k in range(1,25):#25
    ...
    for lam in LAMval:
        ...
        ruta = './restoration/P275B/deblur_P275B_'
        fname = ruta + str(Lambda)  + nameimg 
        out_img_avg_pil.save(fname)

        #Save best image 
        imgPNSRmax_pil = np_to_pil(imgPNSRmax_np)
        fname = './restoration/P275B/BestPnsr_P275B_' + str(Lambda) + nameimg 
    ...
    name = nameimg.replace('.png','.csv')
    #name = 'KodimTotal.csv'
    fname = ruta  + 'P275BdebMAXval' + name
