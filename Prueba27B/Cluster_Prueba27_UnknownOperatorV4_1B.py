...
for k in range(1,25):#25
    ...
    for lam in LAMval:
        ...
        ruta = './restoration/P271B/deblur_P271B_'
        fname = ruta + str(Lambda)  + nameimg 
        out_img_avg_pil.save(fname)

        #Save best image 
        imgPNSRmax_pil = np_to_pil(imgPNSRmax_np)
        fname = './restoration/P271B/BestPnsr_P271B_' + str(Lambda) + nameimg 
...
#name = nameimg.replace('.png','.csv')
name = 'KodimTotal.csv'
fname = ruta  + 'P271BdebMAXval' + name
