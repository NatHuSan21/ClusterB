...
listaRep =[2,3,4,6,10,12,15,16,17,19,21,23]
...
namefig = './outGraf/' + 'BestImgREP'+ Nprueb +'p1.png' 
...
namefig = './outGraf/' + 'BestImgREP'+ Nprueb +'p2.png' 
...
namefig = './outGraf/' + 'BestImgREP'+ Nprueb +'p3.png' 
...
namefig = './outGraf/' + 'BestImgREP'+ Nprueb +'E.png' 
...
namefig = './outGraf/' + 'grafPNSRImgREP'+ Nprueb +'p1.png' 
...
namefig = './outGraf/' + 'grafPNSRImgREP'+ Nprueb +'p2.png'
...
namefig = './outGraf/' + 'grafPNSRImgREP'+ Nprueb +'p3.png' 
...
namefig = './outGraf/' + 'grafPNSRImgREP'+ Nprueb +'E.png' 
...
for i in range(1,4):
    namefig = './outGraf/' + 'grafPNSRImgREP'+ Nprueb +'p'+str(i)+'.png' 
