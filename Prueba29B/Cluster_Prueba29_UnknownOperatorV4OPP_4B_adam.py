...
for k in listaRep:#[:1]:#25
    ...
    for lam in LAMval:
        ...
        ruta = './restoration/P294B/denoised_P294B_'
        fname = ruta + str(Lambda)  + nameimg 
        out_img_avg_pil.save(fname)

        #Save best image 
        imgPNSRmax_pil = np_to_pil(imgPNSRmax_np)
        fname = './restoration/P294B/BestPnsr_P294B_' + str(Lambda) + nameimg 
    ...
    ruta = './txt294B/'
    name = nameimg.replace('.png','.csv')
    fname = ruta  + 'P294BdenMAXval' + name
