...
for k in listaRep[2:]:#25
    ...
    for lam in LAMval:
        ...
        ruta = './restoration/P293B/denoised_P293B_'
        fname = ruta + str(Lambda)  + nameimg 
        out_img_avg_pil.save(fname)

        #Save best image 
        imgPNSRmax_pil = np_to_pil(imgPNSRmax_np)
        fname = './restoration/P293B/BestPnsr_P293B_' + str(Lambda) + nameimg 
    ...
    ruta = './txt293B/'
    name = nameimg.replace('.png','.csv')
    fname = ruta  + 'P293BdenMAXval' + name
