...
for k in listaRep:#[:1]:#25
    ...
    for lam in LAMval:
        ...
        ruta = './restoration/P295B/denoised_P295B_'
        fname = ruta + str(Lambda)  + nameimg 
        out_img_avg_pil.save(fname)

        #Save best image 
        imgPNSRmax_pil = np_to_pil(imgPNSRmax_np)
        fname = './restoration/P295B/BestPnsr_P295B_' + str(Lambda) + nameimg 
    ...
    ruta = './txt295B/'
    name = nameimg.replace('.png','.csv')
    fname = ruta  + 'P295BdenMAXval' + name
